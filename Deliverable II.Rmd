...
The following code loads the validate data, which will be used to test the predictive power of the models we have chosen. We will first create corresponding "isPomfret", "isRiver", and "isFloodZone" columns in the validate data set, and then calculate predicted error for each of the three models. 
