...
Starting with closing price with respect to acres, we proceeded to add variables we though might be important, such as water body type, rooms total, total square feet, tax gross amount, and existance of a garage, as we noted the garage variable to be meaningful regressions run earlier in this report. When we found out that rivers, Pomfret, and flood zones might be significant, we created additional Boolean variables to denote whether these variables existed. 
