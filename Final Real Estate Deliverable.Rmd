...
```
With 95% confidence, total revenue on the test data lies between $145,293.60 and $414,786.40. We were able to find this by adding the predicted assessment deviation to the assessment value for each property. 
