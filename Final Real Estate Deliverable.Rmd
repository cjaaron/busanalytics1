...
OLD NUMBER 8 **8. What is the predicted closing price for the training data, given your regression model? How does it compare with actual closing price?**
...
plot(y = train$price_closed, x = train$id, type = "l", 
     main = "Real v. Predicted Closing Price for Train Data", 
     xlab = "Property Number", 
     ylab = "Price", col = "red")
...
**Summarize your findings for MLS’ managers, and make recommendations for their improving their closing price prediction strategy.**
